...
import { z } from "zod";
import "./Users.css"; // importa o CSS
...
// definição de tipo do usuário (TS)
interface User {
  _id: string;
  name: string;
  email: string;
...
export default function Users() {
  ...
  async function fetchUsers() {
    try {
      ...
      setUsers(data);
      if (!res.ok) setErrors({ server: ["No users found"] });
    } catch (error: any) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        setErrors(data.errors || { server: ["Unknown error"] });
        return;
      }
  ...
  return (
    <div className="users-container">
      <div className="form-card">
        ...
        <form onSubmit={handleSubmit} className="user-form">
          ...
          <div>
            ...
            />
            {errors.email && (
              <p className="error">{errors.email.join(", ")}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.age && (
              <p className="error">{errors.age.join(", ")}</p>
            )}
          </div>
      ...
      <button onClick={fetchUsers} className="fetch-btn">
        Fetch Users
      </button>
